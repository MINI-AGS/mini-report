...
def reporte_distribucion_trastornos(filename):
    ...
    crear_tabla(
        ws_reporte, type_table="TableStyleMedium2", table_name="TablaTrastornos"
    )
    ...
    data = Reference(
        ws_reporte, min_col=2, min_row=1, max_row=len(conteo_trastornos) + 1
    )
    categories = Reference(
        ws_reporte, min_col=1, min_row=2, max_row=len(conteo_trastornos) + 1
    )
